...
vlog -vlog01compat -work work +incdir+D:/CLPD/mux_2_1 {D:/CLPD/mux_2_1/mux_2_1.v}

vlog -vlog01compat -work work +incdir+D:/CLPD/mux_2_1 {D:/CLPD/mux_2_1/mux_2_1_test.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  mux_2_1_test
